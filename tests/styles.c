...
static void assert_equal_color(guint expected, guint actual) {
...
static void test_value(const void* data) {
    ...
    target_file = g_build_filename(test_utils_get_test_data_path(), fixture->file_path, NULL);
...
static const FixtureData fixtures[] = {
    ...
    {"/styles/selectors/#id prior than class", NULL, "styles/order.svg", "#green", "fill",
     .expected.color = 0xff008000},
    ...
    {"/styles/selectors/2 or more selectors (fill)", "592207", "styles/bug592207.svg", "#target", "fill",
     .expected.color = 0xffff0000},
    {"/styles/selectors/2 or more selectors (stroke)", "592207", "styles/bug592207.svg", "#target", "stroke",
     .expected.color = 0xff0000ff},
