...
static void load_n_bytes_at_a_time(gconstpointer data) {
...
static TestData tests[] = {
    ...
    {"/loading/compressed-two-bytes-at-a-time", "loading/gnome-cool.svgz",
     2} /* to test reading the entire gzip header */
};
