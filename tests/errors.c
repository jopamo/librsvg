...
static char* get_test_filename(const char* basename) {
    return g_build_filename(test_utils_get_test_data_path(), "errors", basename, NULL);
}

static void test_loading_error(gconstpointer data) {
...
int main(int argc, char** argv) {
    ...
    g_test_add_data_func_full("/errors/instancing_limit/323-nested-use.svg", "323-nested-use.svg",
                              test_instancing_limit, NULL);

    g_test_add_data_func_full("/errors/instancing_limit/515-pattern-billion-laughs.svg",
                              "515-pattern-billion-laughs.svg", test_instancing_limit, NULL);

    g_test_add_data_func_full("/errors/instancing_limit/308-use-self-ref.svg", "308-use-self-ref.svg",
                              test_instancing_limit, NULL);
    g_test_add_data_func_full("/errors/instancing_limit/308-recursive-use.svg", "308-recursive-use.svg",
                              test_instancing_limit, NULL);
    g_test_add_data_func_full("/errors/instancing_limit/308-doubly-recursive-use.svg", "308-doubly-recursive-use.svg",
                              test_instancing_limit, NULL);
