...
static void rsvg_cairo_clip_apply_affine(RsvgCairoClipRender* render, cairo_matrix_t* affine) {
...
static void rsvg_cairo_clip_render_pango_layout(RsvgDrawingCtx* ctx, PangoLayout* layout, double x, double y) {
...
static void rsvg_cairo_clip_render_path(RsvgDrawingCtx* ctx, const cairo_path_t* path) {
    RsvgCairoClipRender* render = RSVG_CAIRO_CLIP_RENDER(ctx->render);
    RsvgCairoRender* cairo_render = &render->super;
...
static void rsvg_cairo_clip_render_surface(RsvgDrawingCtx* ctx,
