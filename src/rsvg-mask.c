...
static void rsvg_mask_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
...
static void rsvg_clip_path_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
