...
static RsvgPaintServer* rsvg_paint_server_solid(guint32 argb) {
...
static RsvgPaintServer* rsvg_paint_server_solid_current_color(void) {
    RsvgPaintServer* result = g_new(RsvgPaintServer, 1);
...
static RsvgPaintServer* rsvg_paint_server_iri(char* iri) {
    RsvgPaintServer* result = g_new(RsvgPaintServer, 1);
...
static void rsvg_stop_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
    double offset = 0;
...
static void rsvg_linear_gradient_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
...
static void rsvg_linear_gradient_free(RsvgNode* node) {
...
RsvgNode* rsvg_new_linear_gradient(void) {
    ...
    grad->hasx1 = grad->hasy1 = grad->hasx2 = grad->hasy2 = grad->hasbbox = grad->hasspread = grad->hastransform =
        FALSE;
    return &grad->super;
}

static void rsvg_radial_gradient_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
...
static void rsvg_radial_gradient_free(RsvgNode* node) {
...
RsvgNode* rsvg_new_radial_gradient(void) {
    ...
    grad->hascx = grad->hascy = grad->hasfx = grad->hasfy = grad->hasr = grad->hasbbox = grad->hasspread =
        grad->hastransform = FALSE;
    return &grad->super;
}

static void rsvg_pattern_set_atts(RsvgNode* self, RsvgHandle* ctx, RsvgPropertyBag* atts) {
...
static void rsvg_pattern_free(RsvgNode* node) {
...
RsvgNode* rsvg_new_pattern(void) {
    ...
    pattern->hasx = pattern->hasy = pattern->haswidth = pattern->hasheight = pattern->hasbbox = pattern->hascbox =
        pattern->hasvbox = pattern->hasaspect = pattern->hastransform = FALSE;
 ...
 * fallback.
 */
static void resolve_fallbacks(RsvgDrawingCtx* ctx,
                              RsvgNode* data,
...
static const char* gradient_get_fallback(RsvgNode* node) {
...
static void linear_gradient_apply_fallback(RsvgNode* node, RsvgNode* fallback_node) {
...
void rsvg_linear_gradient_fix_fallback(RsvgDrawingCtx* ctx, RsvgLinearGradient* grad) {
    resolve_fallbacks(ctx, (RsvgNode*)grad, (RsvgNode*)grad, gradient_get_fallback, linear_gradient_apply_fallback);
}

static void radial_gradient_apply_fallback(RsvgNode* node, RsvgNode* fallback_node) {
...
void rsvg_radial_gradient_fix_fallback(RsvgDrawingCtx* ctx, RsvgRadialGradient* grad) {
    resolve_fallbacks(ctx, (RsvgNode*)grad, (RsvgNode*)grad, gradient_get_fallback, radial_gradient_apply_fallback);
}

static const char* pattern_get_fallback(RsvgNode* node) {
...
static void pattern_apply_fallback(RsvgNode* pattern_node, RsvgNode* fallback_node) {
    RsvgPattern* pattern;
...
void rsvg_pattern_fix_fallback(RsvgDrawingCtx* ctx, RsvgPattern* pattern) {
    resolve_fallbacks(ctx, (RsvgNode*)pattern, (RsvgNode*)pattern, pattern_get_fallback, pattern_apply_fallback);
}
