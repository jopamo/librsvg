...
#define cr_utils_trace(a_log_level, a_msg)                                                           \
    g_log(CROCO_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): %s\n", __FILE__, __LINE__, \
          __PRETTY_FUNCTION__, a_msg)
#else /*__GNUC__*/

#define cr_utils_trace(a_log_level, a_msg) \
    g_log(CROCO_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "file %s: line %d: %s\n", __FILE__, __LINE__, a_msg)
#endif
